...
public:
    ...
    // Reference: 0x6F24E0
    static void AdjustAngleGivenSpeedAndTime(float* currentAngle, const float targetAngle, const float speed,
    ...
    // Location: 0x6F25E0
    static void WrapFloatGivenCrap(float* currentAngle, float a2, float a3, float minAngle, float maxAngle, float a6,
                                   float deltaTime)
    {
    ...
    static Hedgehog::Math::CVector MatrixTransformVector(const Hedgehog::Math::CMatrix44& in_rMatrix,
                                                         const Hedgehog::Math::CVector& in_rBaseVector)
    {
