...
typedef hh::math::CVector4 CVector4;

#define PARAM_FLOAT(x) in_rEditParam.CreateParamFloat(&x, #x)
#define PARAM_INT(x) in_rEditParam.CreateParamInt(&x, #x)
#define PARAM_BOOL(x) in_rEditParam.CreateParamBool(&x, #x)
#define PARAM_VEC(x) in_rEditParam.CreateParamBase(Sonic::CParamPosition::Create((Hedgehog::Math::CVector*)&x), #x)