...
#define MAKE_BASIC_OPTIMIZED_CTOR(className, address, reg) \
    ...
    public:
        ...
        BB_OVERRIDE_FUNCTION_PTR_NOARG(void, CSetObjectListener, OnSetEditorEnter, 0x1004EC0)
        BB_OVERRIDE_FUNCTION_PTR_NOARG(void, CSetObjectListener, OnSetEditorLeave, 0x01004EB0)
