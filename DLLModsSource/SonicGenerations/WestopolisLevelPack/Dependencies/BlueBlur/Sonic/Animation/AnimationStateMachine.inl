namespace Sonic
{
    ...
    static void __declspec(noinline) fCAnimationStateMachineSetBlend(CAnimationStateMachine* This,
        const Hedgehog::Base::CSharedString& in_rState, const Hedgehog::Base::CSharedString& in_rTargetState, float in_BlendTime)
    {
        static constexpr uint32_t func = 0x00CE0720;
        __asm
        {
            mov ecx, This
            mov eax, in_rTargetState
            mov edi, in_rState
            push in_BlendTime
            call func
        }
    ...
    inline void CAnimationStateMachine::SetBlend(const Hedgehog::Base::CSharedString& in_rState, const Hedgehog::Base::CSharedString& in_rTargetState, float in_BlendTime)
    {
        fCAnimationStateMachineSetBlend(this, in_rState, in_rTargetState, in_BlendTime);
    }
}